...
const users = [
  new User({id: 'Victoria', club_theme_house_created_by_me: ['American Chemical Society']
  }),
  new User({id: 'Rita',club_theme_house_created_by_me: ['The Hub']
  }),
  new User({id: 'Taeyun', club_theme_house_created_by_me: ['L.I.G.H.T. House']
  })
